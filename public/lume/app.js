...
const boldIcons = [
    ...
    { id: 'arrow-down-1-bold', name: 'Arrow Down Alt', category: 'interface', path: '/lume/Bold/arrow-down (1).svg' },
    { id: 'arrow-left-bold', name: 'Arrow Left', category: 'interface', path: '/lume/Bold/arrow-left.svg' },
    { id: 'arrow-left-1-bold', name: 'Arrow Left Alt', category: 'interface', path: '/lume/Bold/arrow-left (1).svg' },
    { id: 'arrow-right-bold', name: 'Arrow Right', category: 'interface', path: '/lume/Bold/arrow-right.svg' },
    { id: 'arrow-right-1-bold', name: 'Arrow Right Alt', category: 'interface', path: '/lume/Bold/arrow-right (1).svg' },
    { id: 'arrow-up-bold', name: 'Arrow Up', category: 'interface', path: '/lume/Bold/arrow-up.svg' },
    { id: 'arrow-up-1-bold', name: 'Arrow Up Alt', category: 'interface', path: '/lume/Bold/arrow-up (1).svg' },
    { id: 'bell-bold', name: 'Bell', category: 'communication', path: '/lume/Bold/bell.svg' },
    { id: 'bell-1-bold', name: 'Bell Alt', category: 'communication', path: '/lume/Bold/bell (1).svg' },
    { id: 'bell-slash-bold', name: 'Bell Slash', category: 'communication', path: '/lume/Bold/bell-slash.svg' },
    { id: 'bell-slash-1-bold', name: 'Bell Slash Alt', category: 'communication', path: '/lume/Bold/bell-slash (1).svg' },
    { id: 'bookmark-bold', name: 'Bookmark', category: 'interface', path: '/lume/Bold/bookmark.svg' },
    { id: 'bookmark-1-bold', name: 'Bookmark Alt', category: 'interface', path: '/lume/Bold/bookmark (1).svg' },
    { id: 'calendar-bold', name: 'Calendar', category: 'interface', path: '/lume/Bold/calendar.svg' },
    { id: 'calendar-1-bold', name: 'Calendar Alt', category: 'interface', path: '/lume/Bold/calendar (1).svg' },
    { id: 'camera-bold', name: 'Camera', category: 'media', path: '/lume/Bold/camera.svg' },
    { id: 'camera-1-bold', name: 'Camera Alt', category: 'media', path: '/lume/Bold/camera (1).svg' },
    { id: 'chart-pie-bold', name: 'Chart Pie', category: 'interface', path: '/lume/Bold/chart-pie.svg' },
    { id: 'chart-pie-1-bold', name: 'Chart Pie Alt', category: 'interface', path: '/lume/Bold/chart-pie (1).svg' },
    { id: 'check-circle-bold', name: 'Check Circle', category: 'interface', path: '/lume/Bold/check-circle.svg' },
    { id: 'check-circle-1-bold', name: 'Check Circle Alt', category: 'interface', path: '/lume/Bold/check-circle (1).svg' },
    { id: 'chevron-circle-down-bold', name: 'Chevron Circle Down', category: 'interface', path: '/lume/Bold/chevron-circle-down.svg' },
    { id: 'chevron-circle-down-1-bold', name: 'Chevron Circle Down Alt', category: 'interface', path: '/lume/Bold/chevron-circle-down (1).svg' },
    { id: 'chevron-circle-left-bold', name: 'Chevron Circle Left', category: 'interface', path: '/lume/Bold/chevron-circle-left.svg' },
    { id: 'chevron-circle-left-1-bold', name: 'Chevron Circle Left Alt', category: 'interface', path: '/lume/Bold/chevron-circle-left (1).svg' },
    { id: 'chevron-circle-right-bold', name: 'Chevron Circle Right', category: 'interface', path: '/lume/Bold/chevron-circle-right.svg' },
    { id: 'chevron-circle-right-1-bold', name: 'Chevron Circle Right Alt', category: 'interface', path: '/lume/Bold/chevron-circle-right (1).svg' },
    { id: 'chevron-circle-up-bold', name: 'Chevron Circle Up', category: 'interface', path: '/lume/Bold/chevron-circle-up.svg' },
    { id: 'chevron-circle-up-1-bold', name: 'Chevron Circle Up Alt', category: 'interface', path: '/lume/Bold/chevron-circle-up (1).svg' },
    { id: 'chevron-down-bold', name: 'Chevron Down', category: 'interface', path: '/lume/Bold/chevron-down.svg' },
    { id: 'chevron-down-1-bold', name: 'Chevron Down Alt', category: 'interface', path: '/lume/Bold/chevron-down (1).svg' },
    { id: 'chevron-left-bold', name: 'Chevron Left', category: 'interface', path: '/lume/Bold/chevron-left.svg' },
    { id: 'chevron-left-1-bold', name: 'Chevron Left Alt', category: 'interface', path: '/lume/Bold/chevron-left (1).svg' },
    { id: 'chevron-right-bold', name: 'Chevron Right', category: 'interface', path: '/lume/Bold/chevron-right.svg' },
    { id: 'chevron-right-1-bold', name: 'Chevron Right Alt', category: 'interface', path: '/lume/Bold/chevron-right (1).svg' },
